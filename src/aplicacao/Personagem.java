...
public class Personagem {
	...
	public Personagem(int pokebolas, int pokemons, int posX, int posY, int pokebolasTotal, int direcao,
			int estadoPokemons, int pontuacao) {
		super();
	...
	public void pegarPokebolas() {
		...
		iLog.setLog("Pegou pokebolas", "pegou 25 pokebolas, agora tem um total de: " + getPokebolasTotal());
	...
	public void virarDireita() {
		...
		iLog.setLog("Virar a direita", "virou a direita, agora esta olhando para o " + getDirecaoString());
	...
	public void virarEsquerda() {
		...
		iLog.setLog("Virar a esquerda", "virou a esquerda, agora esta olhando para o " + getDirecaoString());
	}
	...
	public void vencerBatalha() {
		this.pontuacao += 150;
		this.estadoPokemons = FERIDOS;
		iLog.setLog("Venceu a batalha", "parabens, agora tem " + getPontuacao() + " pontos");
	}

	public void perderBatalha() {
		this.pontuacao -= 1000;
		iLog.setLog("Perdeu a batalha", "melhor sorte na proxima, agora tem " + getPontuacao() + " pontos");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------------------------------------------");
		System.out.println(treinador);
		Pokemon pokemon = new Pokemon("teste", 1, Pokemon.ELECTRIC, Pokemon.VAZIO, null);
	...
	public void draw(Graphics2D g) {
		g.drawImage(animation.getImage(), this.posX * size, this.posY * size, this.size, this.size, null);
	}
